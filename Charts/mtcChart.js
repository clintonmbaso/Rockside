       ...
       function drawChart() {
         ...
         data.addRows([
           // President
   		[{v:'President', f:'<div class="node" onclick="showDetails(\'Ps. Maxwell Muwvimi\', \'<br> +260 00 0 000 000\', \'images/3.jpg\')"><img src="images/3.jpg" class="node-image"><div class="node-label">President</div></div>'}, '', 'KEMD President', 'images/3.jpg'],
   		
   		// Secretary
   		[{v:'Executive Secretary', f:'<div class="node" onclick="showDetails(\'Ps. J. Siachibila\', \'A self motivated inspirational leader that delights in seing things moving.\', \'images/3.jpg\')"><img src="images/3.jpg" class="node-image"><div class="node-label">Secretary A</div></div>'}, 'Vice President A', 'KEMD-Zone A Secretary', 'images/3.jpg'],
   		
   		// Treasurer
   		[{v:'Chief Financial Officer', f:'<div class="node" onclick="showDetails(\'Elder Nkulukusa\', \'A self motivated inspirational leader that delights in seing things moving.\', \'images/3.jpg\')"><img src="images/3.jpg" class="node-image"><div class="node-label">Treasurer A</div></div>'}, 'Vice President A', 'KEMD-Zone A Treasurer', 'images/3.jpg'],
