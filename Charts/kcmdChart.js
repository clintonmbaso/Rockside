       ...
       function drawChart() {
         ...
         // President
   		...
   		// Treasurer
   		[{v:'Treasurer', f:'<div class="node" onclick="showDetails(\'MUCHANETA MUGOBA\', \'Kabwe Central SDA Church\', \'../images/KCMD/KCMDTreasurer.jpg\', \'+260000000000\')"><img src="../images/KCMD/KCMDTreasurer.jpg" class="node-image"><div class="node-label">Treasurer</div></div>'}, 'Associate Secretary', 'KCMD - Treasurer', '../images/KCMD/KCMDTreasurer.jpg'],
   		...
   		// Parliamentarian
   		[{v:'Parliamentarian', f:'<div class="node" onclick="showDetails(\'GISPER KUMASA\', \'Kabwe Central SDA Church\', \'../images/KCMD/KCMDParliamentarian.jpg\', \'+260000000000\')"><img src="../images/KCMD/KCMDParliamentarian.jpg" class="node-image"><div class="node-label">Parliamentarian</div></div>'}, 'Vice Treasurer', 'KCMD - Parliamentarian', '../images/KCMD/KCMDParliamentarian.jpg'],

   		// Education
   		[{v:'Education Director', f:'<div class="node" onclick="showDetails(\'ELDER PETER MAYUYA\', \'Kabwe Central SDA Church\', \'../images/KCMD/KCMDEducationDirector.jpg\', \'+260000000000\')"><img src="../images/KCMD/KCMDEducationDirector.jpg" class="node-image"><div class="node-label">Education Director</div></div>'}, 'Parliamentarian', 'KCMD - Education Director', '../images/KCMD/KCMDEducation Director.jpg'],
   		...
   		// Pathfinder Ministry
   		[{v:'Pathfinder', f:'<div class="node" onclick="showDetails(\'HERMES MALELE\', \'Kabwe Central SDA Church\', \'../images/KCMD/KCMDPathfinder.jpg\', \'+260000000000\')"><img src="../images/KCMD/KCMDPathfinder.jpg" class="node-image"><div class="node-label">Pathfinder</div></div>'}, 'Ambassador Secretary', 'KCMD - Pathfinder', '../images/KCMD/KCMDPathfinder.jpg'],
   		[{v:'Pathfinder Secretary', f:'<div class="node" onclick="showDetails(\'LYNESS PUNGWA\', \'Kabwe Central SDA Church\', \'../images/KCMD/KCMDPathfinderSecretary.jpg\', \'+260000000000\')"><img src="../images/KCMD/KCMDVicePathfinderSecretary.jpg" class="node-image"><div class="node-label">Pathfinder Secretary</div></div>'}, 'Pathfinder', 'KCMD - Pathfinder Secretary', '../images/KCMD/KCMDVicePathfinderSecretary.jpg'],
   		...
   		// Adventurer Ministry
   		[{v:'Adventurer', f:'<div class="node" onclick="showDetails(\'LONGOWE KANGWENDA\', \'Kabwe Central SDA Church\', \'../images/KCMD/KCMDAdventurer.jpg\', \'+260000000000\')"><img src="../images/KCMD/KCMDAdventurer.jpg" class="node-image"><div class="node-label">Adventurer</div></div>'}, 'Field Marshal', 'KCMD - Adventurer', '../images/KCMD/KCMDAdventurer.jpg'],
   		...
   		// Communication
   		[{v:'Media Director', f:'<div class="node" onclick="showDetails(\'Herold Blessed Kalawela\', \'Kabwe Central SDA Church\', \'../images/KCMD/KCMDMediaDirector.jpg\', \'+260770023995\')"><img src="../images/KCMD/KCMDMediaDirector.jpg" class="node-image"><div class="node-label">Media Director</div></div>'}, 'Vice Music Director', 'KCMD - Media Director', '../images/KCMD/KCMDMediaDirector.jpg'],
         
   		// Planning / Projects
   		[{v:'Projects Coordinator', f:'<div class="node" onclick="showDetails(\'Hirah Malambo\', \'Kabwe Central SDA Church\', \'../images/KCMD/KCMDProjectsCoordinator.jpg\', \'+260973801744\')"><img src="../images/KCMD/KCMDProjectsCoordinator.jpg" class="node-image"><div class="node-label">Projects Coordinator</div></div>'}, 'Media Director', 'KCMD - Projects Coordinator', '../images/KCMD/KCMDProjectsCoordinator.jpg'],
   		...
   		[{v:'Youth Matron', f:'<div class="node" onclick="showDetails(\'MERCY MUGOBA\', \'Kabwe Central SDA Church\', \'../images/KCMD/KCMDMatron.jpg\', \'+260000000000\')"><img src="../images/KCMD/KCMDMatron.jpg" class="node-image"><div class="node-label">Youth Matron</div></div>'}, 'Projects Secretary', 'KCMD - Youth Matron', '../images/KCMD/KCMDMatron.jpg'],
