  ...
  hymns: [
    {
      ...
      year: 1860,
      category: "grace",
      lyrics: `Watchman, blow the gospel trumpet,
...
Sweetly saying, “Come to me”. 
    ...
    },
    {
      ...
      year: 1860,
      category: "grace",
      lyrics: `The coming King is at the door,
...
And time eternity. `,
    ...
    },
    {
      ...
      year: 1860,
      category: "grace",
      lyrics: `Face to face with Christ my Saviour,
...
Jesus Christ who loves so.
  ...
  categories: [
    { id: "worship", name: "Worship & Praise", icon: "fas fa-cross", description: "Hymns focused on adoration and exaltation of God" },
    { id: "grace", name: "Love & Grace", icon: "fas fa-heart", description: "Songs celebrating God's love and redeeming grace" },
    { id: "prayer", name: "Prayer & Devotion", icon: "fas fa-pray", description: "Hymns for personal reflection and communion with God" },
    { id: "scripture", name: "Scripture Based", icon: "fas fa-bible", description: "Hymns directly inspired by biblical passages" },
    { id: "faithfulness", name: "God's Faithfulness", icon: "fas fa-shield-alt", description: "Hymns about God's unchanging nature and promises" },
    { id: "peace", name: "Peace & Comfort", icon: "fas fa-dove", description: "Hymns offering solace and spiritual peace" }
  ]
};