       ...
       function drawChart() {
         ...
         // President
   		...
   		[{v:'Vice President B', f:'<div class="node" onclick="showDetails(\'Jere Beatrice\', \'Rockside SDA Church\', \'../images/KEMD/PresidentB.jpg\', \'+260967809417\')"><img src="../images/KEMD/PresidentB.jpg" class="node-image"><div class="node-label">Vice President B</div></div>'}, 'President', 'KEMD-Zone B Vice President', '../images/KEMD/PresidentB.jpg'],
   		...
   		[{v:'Secretary B', f:'<div class="node" onclick="showDetails(\'Emma Muleya\', \'Luanshimba SDA Church\', \'../images/KEMD/SecretaryB.jpg\', \'+260763673672\')"><img src="../images/KEMD/SecretaryB.jpg" class="node-image"><div class="node-label">Secretary B</div></div>'}, 'Vice President B', 'KEMD-Zone B Secretary', '../images/KEMD/SecretaryB.jpg'],
   		...
   		// Chaplain
   		[{v:'Chaplain A', f:'<div class="node" onclick="showDetails(\'Melvin Mwila\', \'SDA Church\', \'../images/KEMD/ChaplainA.jpg\', \'+260975962320\')"><img src="../images/KEMD/ChaplainA.jpg" class="node-image"><div class="node-label">Chaplain A</div></div>'}, 'Vice President A', 'KEMD-Zone A Chaplain', '../images/KEMD/ChaplainA.jpg'],
   		[{v:'Chaplain B', f:'<div class="node" onclick="showDetails(\'Lucky Ngandu\', \'Luanshimba SDA Church\', \'../images/KEMD/ChaplainB.jpg\', \'+260974712906\')"><img src="../images/KEMD/ChaplainB.jpg" class="node-image"><div class="node-label">Chaplain B</div></div>'}, 'Vice President B', 'KEMD-Zone B Chaplain', '../images/KEMD/ChaplainB.jpg'],
   		...
   		[{v:'Ambassador B', f:'<div class="node" onclick="showDetails(\'Kebby Chimbulu\', \'Muteteshi SDA Church\', \'../images/KEMD/AmbassadorB.jpg\', \'+260777900745\')"><img src="../images/KEMD/AmbassadorB.jpg" class="node-image"><div class="node-label">Ambassador B</div></div>'}, 'Secretary B', 'KEMD-Zone B Ambassador', '../images/KEMD/AmbassadorB.jpg'],
   		...
   		[{v:'Pathfinder B', f:'<div class="node" onclick="showDetails(\'Bwalya Moris\', \'Rockside SDA Church\', \'../images/KEMD/PathfinderB.jpg\', \'+260766613234\')"><img src="../images/KEMD/PathfinderB.jpg" class="node-image"><div class="node-label">Pathfinder B</div></div>'}, 'Secretary B', 'KEMD-Zone B Pathfinder', '../images/KEMD/PathfinderB.jpg'],
   		...
   		[{v:'Adventurer B', f:'<div class="node" onclick="showDetails(\'Nelson Tapheni\', \'Mapulu SDA Church\', \'images/KEMD/AdventurerB.jpg\', \'+260974835595\')"><img src="images/KEMD/AdventurerB.jpg" class="node-image"><div class="node-label">Adventurer B</div></div>'}, 'Secretary B', 'KEMD-Zone B Adventurer', 'images/KEMD/AdventurerB.jpg'],
   		...
   		[{v:'Communication B', f:'<div class="node" onclick="showDetails(\'Daswell Muzyamba\', \'Kabufumu SDA Church\', \'../images/KEMD/CommunicationB.jpg\', \'+260770758088\')"><img src="../images/KEMD/CommunicationB.jpg" class="node-image"><div class="node-label">Communication B</div></div>'}, 'Secretary B', 'KEMD-Zone B Communication', '../images/KEMD/CommunicationB.jpg'],
   		...
   		[{v:'Education B', f:'<div class="node" onclick="showDetails(\'Mbaso Clinton\', \'Rockside SDA Church\', \'../images/KEMD/EducationB.jpg\', \'+260968084570\')"><img src="../images/KEMD/EducationB.jpg" class="node-image"><div class="node-label">Education B</div></div>'}, 'Secretary B', 'KEMD-Zone B Education', '../images/KEMD/EducationBp.jpg'],
   		...
   		// Field Marshal
   		[{v:'Field Marshal A', f:'<div class="node" onclick="showDetails(\'Owen Thomas\', \'SDA Church\', \'../images/KEMD/Field MarshalA.jpg\', \'+260750498756\')"><img src="../images/KEMD/Field MarshalA.jpg" class="node-image"><div class="node-label">Field Marshal A</div></div>'}, 'Parliamentarian A', 'KEMD-Zone A Field Marshal', '../images/KEMD/Field MarshalA.jpg'],
   		[{v:'Field Marshal B', f:'<div class="node" onclick="showDetails(\'Joseph Peche\', \'Muteteshi SDA Church\', \'../images/KEMD/fieldMarshalB.jpg\', \'+260760163228\')"><img src="../images/KEMD/fieldMarshalB.jpg" class="node-image"><div class="node-label">Field Marshal B</div></div>'}, 'Parliamentarian B', 'KEMD-Zone B Field Marshal', '../images/KEMD/fieldMarshalB.jpg'],
