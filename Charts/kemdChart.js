       ...
       function drawChart() {
         ...
         // President
   		...
   		// Treasurer
   		[{v:'Treasurer A', f:'<div class="node" onclick="showDetails(\'Chipo Musonda\', \'Lukanga Main SDA Church\', \'../images/KEMD/TreasurerA.jpg\', \'+260978973834\')"><img src="../images/KEMD/TreasurerA.jpg" class="node-image"><div class="node-label">Treasurer A</div></div>'}, 'Vice President A', 'KEMD-Zone A Treasurer', '../images/KEMD/TreasurerA.jpg'],
   		...
   		// Chaplain
   		[{v:'Chaplain A', f:'<div class="node" onclick="showDetails(\'details\', \'SDA Church\', \'../images/KEMD/ChaplainA.jpg\', \'+260975962320\')"><img src="../images/KEMD/ChaplainA.jpg" class="node-image"><div class="node-label">Chaplain A</div></div>'}, 'Secretary A', 'KEMD-Zone A Chaplain', '../images/KEMD/ChaplainA.jpg'],
   		...
   		// Pathfinder Ministry
   		[{v:'Pathfinder A', f:'<div class="node" onclick="showDetails(\'Stainly Mubengwa\', \'Lukanga Main SDA Church\', \'../images/KEMD/PathfinderA.jpg\', \'+260772678431\')"><img src="../images/KEMD/PathfinderA.jpg" class="node-image"><div class="node-label">Pathfinder A</div></div>'}, 'Secretary A', 'KEMD-Zone A Pathfinder', '../images/KEMD/PathfinderA.jpg'],
   		...
   		[{v:'Vice Pathfinder Aa', f:'<div class="node" onclick="showDetails(\'Morgan Lushinga\', \'Nabusanga SDA Church\', \'../images/KEMD/vicePathfinderAa.jpg\', \'+260774193676\')"><img src="../images/KEMD/vicePathfinderAa.jpg" class="node-image"><div class="node-label">Vice Pathfinder Aa</div></div>'}, 'Pathfinder A', 'KEMD-Zone A Vice Pathfinder 1', '../images/KEMD/vicePathfinderAa.jpg'],
   		[{v:'Vice Pathfinder Ab', f:'<div class="node" onclick="showDetails(\'Chipego Mwanza\', \'Kamushanga SDA Church\', \'../images/KEMD/vicePathfinderAb.jpg\', \'+260975319942\')"><img src="../images/KEMD/vicePathfinderAb.jpg" class="node-image"><div class="node-label">Vice Pathfinder Ab</div></div>'}, 'Pathfinder A', 'KEMD-Zone A Vice Pathfinder 2', '../images/KEMD/vicePathfinderAb.jpg'],
   		...
   		// Adventurer Ministry
   		[{v:'Adventurer A', f:'<div class="node" onclick="showDetails(\'Twaambo \', \'Lukanga Main SDA Church\', \'images/KEMD/AdventurerA.jpg\', \'+260774237825\')"><img src="images/KEMD/AdventurerA.jpg" class="node-image"><div class="node-label">Adventurer A</div></div>'}, 'Secretary A', 'KEMD-Zone A Adventurer', 'images/KEMD/AdventurerA.jpg'],
   		...
   		// Planning / Projects
   		[{v:'Planning/Projects A', f:'<div class="node" onclick="showDetails(\'Justin Mulwanda\', \'Lukanga Main SDA Church\', \'../images/KEMD/ProjectsA.jpg\', \'+260974738615\')"><img src="../images/KEMD/ProjectsA.jpg" class="node-image"><div class="node-label">Planning/Projects A</div></div>'}, 'Treasurer A', 'KEMD-Zone A Planning and Project Coordinator', '../images/KEMD/ProjectsA.jpg'],
